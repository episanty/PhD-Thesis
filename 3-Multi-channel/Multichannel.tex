...
\begin{figure}[htbp]
  \centering
  \subfloat[\label{f3-direct-vs-correlated-direct}]{\includegraphics[width=\figurethreeblwidth]{3-Multi-channel/Figures/figure3Ba.png}}
  $\ $
  \subfloat[\label{f3-direct-vs-correlated-midbarrier}]{\includegraphics[width=\figurethreeblwidth]{3-Multi-channel/Figures/figure3Bb.png}}
  $\ $
  \subfloat[\label{f3-direct-vs-correlated-postionization}]{\includegraphics[width=\figurethreeblwidth]{3-Multi-channel/Figures/figure3Bc.png}}
