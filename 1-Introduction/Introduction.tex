...
%Finally, we mention here the contributions present in this thesis to the trajectory language entailed by ARM theory, which we will explore in chapters~\ref{chap:quantum-orbits} and~\ref{chap:LES-NZES}, and which have been published in Refs.~\citealp{ Pisanty_slalom_2016} and~\citealp{Pisanty_kinematic_2016}.
...
%\cite{kaushal_thesis}
%\cite{ARM_initial}
%\cite{ARM_initial_multielectron}
%\cite{ARM_trajectories}
%\cite{ARM_abinitio_verification}
%\cite{ARM_attoclock}
%\cite{ARM_circular}
%\cite{ARM_Coulomb_HHG}
%\cite{ARM_spin-orbit}
...
%; this also allows the theory to have a quasi-time-independent treatment of the ionization process by using the Floquet quasi-eigenstates of the free-particle problem. More interestingly, it is possible to match 
