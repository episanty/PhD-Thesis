...
(*************************************************************************)
(* This file contains the package MaTeX by Szabolcs Horvát (c) 2016.     *)
(* It is included unter its MIT license for completeness and to have a   *)
(* self-contained implementation. For more details, and to get the most  *)
(* recent version, go to the MaTeX homepage at                           *)
